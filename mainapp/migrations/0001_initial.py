# Generated by Django 2.0.2 on 2018-04-24 11:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gnr_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='genrestylegenre', to='mainapp.Genre')),
            ],
        ),
        migrations.CreateModel(
            name='LikedTrack',
        ...
        migrations.AddField(
            model_name='album',
            name='stl_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='genrealbum', to='mainapp.GenreStyle'),
        ),
    ]
