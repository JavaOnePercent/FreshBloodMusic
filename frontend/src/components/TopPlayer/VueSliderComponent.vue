...
<div 
ref="wrap" 
:class="['vue-slider-component', myCSS, flowDirection, disabledClass, stateClass, { 'vue-slider-has-label': piecewiseLabel }]" 
v-show="show" 
:style="wrapStyles"
@mousedown="wrapClick"
>
...
<style scoped>
  ...
  .vue-slider-component .vue-slider {
    ...
    display: block;
    border-radius: 15px;
    background-color: /*#ccc*/rgba(204, 204, 204, 0.8);;
